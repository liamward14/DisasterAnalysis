# -*- coding: utf-8 -*-
"""
Created on Wed May  6 14:24:15 2020
...
fig = px.choropleth(winter_subset, geojson=counties, locations='FIPS', color='Winter',
                    color_continuous_scale="Viridis",
                    range_color=winter_range,
                    labels={'Winter':'Occurences'}
                    )

#Add title and scale layout
fig.update_layout(margin={"r":0,"t":40,"l":0,"b":40},
                  height=720,
                  title_text = 'Major Winter Damage Occurences Since 1953')

fig.update_geos(fitbounds="locations", visible=False) #zoom in on California
#fig.show() #uncomment in order to see the figure

path = r'C:\Users\liamw\PycharmProjects\California\WinterMap.html'
